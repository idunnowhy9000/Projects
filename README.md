...
**Alarm Clock** - A simple clock where it plays a sound after X number of minutes/seconds or at a particular time. [(C++)](https://github.com/idunnowhy9000/Projects/blob/master/SOURCE/C%2B%2B/Numbers/Alarm%20Clock.cpp)
...
**Fast Exponentiation** - Ask the user to enter 2 integers a and b and output a^b (i.e. pow(a,b)) in O(lg n) time complexity. [(C++)](https://github.com/idunnowhy9000/Projects/blob/master/SOURCE/C%2B%2B/Numbers/Fast%20Exponentiation.cpp)
...
**Sieve of Eratosthenes** - The sieve of Eratosthenes is one of the most efficient ways to find all of the smaller primes (below 10 million or so). [(Python)](https://github.com/idunnowhy9000/Projects/blob/master/SOURCE/Python/Classic%20Algorithms/Sieve%20of%20Eratosthenes.py)
...
**Reverse a String** - Enter a string and the program will reverse it and print it out. [(C++)](https://github.com/idunnowhy9000/Projects/blob/master/SOURCE/C%2B%2B/Text/Reverse%20String.cpp)
...
**Count Words in a String** - Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary. [(C++)](https://github.com/idunnowhy9000/Projects/blob/master/SOURCE/C%2B%2B/Text/Word%20Counter.cpp)
...
**Get Atomic Time from Internet Clock** - This program will get the true atomic time from an atomic time clock on the Internet. Use any one of the atomic clocks returned by a simple Google search. [(Python)](https://github.com/idunnowhy9000/Projects/blob/master/SOURCE/Python/Web/Atomic%20Time.py)
...
**Caesar cipher** - Implement a Caesar cipher, both encoding and decoding. The key is an integer from 1 to 25. This cipher rotates the letters of the alphabet (A to Z). The encoding replaces each letter with the 1st to 25th next letter in the alphabet (wrapping Z to A). So key 2 encrypts "HI" to "JK", but key 20 encrypts "HI" to "BC". This simple "monoalphabetic substitution cipher" provides almost no security, because an attacker who has the encoded message can either use frequency analysis to guess the key, or just try all 25 keys. [(Python)](https://github.com/idunnowhy9000/Projects/blob/master/SOURCE/Python/Security/Caesar%20Cipher.py)